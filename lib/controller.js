...
function Controller(params) {
  ...
  this.createPluginAPI(plugin_api_parameters);
...
Controller.prototype.addAccessory = function(api_accessory) {
  ...
  this.sendAck("Controller.addAccessory", ack, message);
...
Controller.prototype.addService = function(api_accessory) {
  ...
  this.sendAck("Controller.addService", ack, message);
}
...
Controller.prototype.removeAccessory = function(name) {
  ...
  this.sendAck("Controller.removeAccessory", ack, message);
}
...
Controller.prototype.removeService = function(api_accessory) {
  ...
  this.sendAck("Controller.remoceService", ack, message);
}
...
Controller.prototype.updateReachability = function(accessory) {
  ...
  this.sendAck("Controller.updateReachability", ack, message);
}

Controller.prototype.setAccessoryInformation = function(accessory, response) {
  ...
  if (typeof this.hap_accessories[name] === "undefined") {
    ...
    this.sendAck("Controller.setAccessoryInformation", ack, message);
  } else {
...
Controller.prototype.getAccessories = function(api_accessory) {
  ...
  if (name !== "*" && typeof(this.accessories[name]) === "undefined") {
    ...
    this.sendAck("Controller.getAccessories", false, message);
...
Controller.prototype.createPluginAPI = function (api_parameters) {

  this.Mqtt = new Mqtt(api_parameters);
}

Controller.prototype.initPluginAPI = function () {
...
Controller.prototype.setValue = function (api_accessory) {
  ...
  if (!ack) {
    this.sendAck("Controller.setValue", ack, message);
  }
}
...
Controller.prototype.sendAccessories = function (accessories) {

  this.Mqtt.sendAccessories(accessories);
}

Controller.prototype.sendAck = function (function_name, ack, message) {
