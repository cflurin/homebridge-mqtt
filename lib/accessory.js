...
var Service, Characteristic, get, set, identify;
...
Accessory.prototype.removeService = function(service_name) {
  ...
  this.hap_accessory.removeService(this.services[service_name]);
...
Accessory.prototype.getService_names = function(accessory) {
  ...
  this.log.debug("Accessory.getService_names %s", JSON.stringify(this.service_names));
}
...
Accessory.prototype.identify = function (paired, callback) {
  ...
  identify(this.name, manufacturer, model, serialnumber);
